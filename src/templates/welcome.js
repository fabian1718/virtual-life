                    ...
                    <table>
                      ...
                      <tr>
                        <td>
                          <p
                            style="font-weight:400;font-size: 16px;line-height: 150%;letter-spacing: 0.2px;color: #333333;">
                            Gracias por registrarte en Virtual Life.
                            Te invitamos a que generes tu primer compra y disfrutes de esta plataforma.
                      ...
                      <tr>
                        <td>
                          <p
                            style="font-weight:400;font-size: 16px;line-height: 150%;letter-spacing: 0.2px;color: #333333;">
                          <p>Atentamente, <br />Equipo Virtual Life</p>
                          </p>
                        </td>
                      </tr>
                      <tr>
                          ...
                          <table style="width:100%">
                            <tr>
                              <td
                                ...
                                <a href="https://fabian-portafolio.netlify.app/"
                                  style="text-decoration: none;color:#ffffff;font-weight: 600;font-size: 18px;">Ir a la tienda </a>
                              </td>
                              <td style="width:30%;">
                              </td>
                            </tr>
